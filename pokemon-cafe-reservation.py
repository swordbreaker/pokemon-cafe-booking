...
def create_booking(
    day_of_month: int, num_of_guests: int, location: str, driver_name: str
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_of_guests",
        type=int,
        help="Number of guests to book (1-8)",
        default=num_of_guests,
        required=False,
    )
    parser.add_argument(
        "--location",
        type=str,
        choices=["Tokyo", "Osaka"],
        help="Location of the cafe (Tokyo or Osaka)",
        default=location,
        required=False,
    )
    parser.add_argument(
        "--iterations",
        type=int,
        help="Number of iterations to run the booking",
    ...
    parser.add_argument(
        ...
        help="Web driver to use (chrome, edge, firefox, or safari)",
        default=driver_name,
        required=False,
    )
    ...
    for _ in range(args.iterations):
        create_booking(
            args.day_of_month, args.num_of_guests, args.location, args.driver
        )
